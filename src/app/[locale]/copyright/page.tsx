...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Anime Origins Wiki',
    description: 'Copyright and intellectual property information for Anime Origins Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Anime Origins Wiki',
      description: 'Copyright and intellectual property information for Anime Origins Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Anime Origins Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Anime Origins Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Anime Origins Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox Corporation</strong> - Owner of the Roblox platform</li>
              <li><strong>SNAP GAMES</strong> - Developer of the Anime Origins game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>In-game units and mechanics</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Anime Origins</strong> - Trademark of SNAP GAMES</li>
              <li><strong>Anime Origins Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Anime Origins Wiki.
            </p>
            ...
            <p>
              ...
              Anime Origins Wiki<br />
              Email: <a href="mailto:dmca@animeorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animeorigins.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to &quot;Anime Origins Wiki&quot;</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>&quot;Source: Anime Origins Wiki (animeorigins.wiki)&quot;</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@animeorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@animeorigins.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@animeorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animeorigins.wiki</a>
            </p>
            <p>
