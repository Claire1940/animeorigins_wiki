...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Anime Origins Wiki',
    description: 'Anime Origins Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox anime tower defense resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Anime Origins Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <ul>
              ...
              <li><strong>Cloudflare:</strong> Hosting, CDN, and security provider</li>
            </ul>
            ...
            <p>
              Our website is hosted on a global CDN. If you are accessing our website from outside the United States,
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Anime Origins Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with SNAP GAMES (Roblox) or the developers of Anime Origins. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@animeorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@animeorigins.wiki</a>
            </p>
            <p>
