...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.animeorigins.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Anime Origins Wiki",
    description: "Read the Terms of Service for Anime Origins Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox anime tower defense resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Anime Origins Wiki",
      description: "Terms and conditions for using Anime Origins Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          alt: "Anime Origins Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Anime Origins Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Anime Origins Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Anime Origins Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Anime Origins Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Anime Origins" by SNAP GAMES. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active codes and redemption guides</li>
              <li>Unit tier lists for Story, Infinite, and Raid modes</li>
              <li>Unit stats, skills, and recommended builds</li>
              <li>Summon banner and gacha guides</li>
              <li>Trait effects and reroll strategies</li>
              <li>Story Mode, Infinite Mode, and Raid walkthroughs</li>
            </ul>
            <p>
              <strong>Important:</strong> Anime Origins Wiki is NOT affiliated with, endorsed by, or associated with
              SNAP GAMES (Roblox) or the official developers of Anime Origins. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Anime Origins Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of SNAP GAMES (Roblox) and/or the developers of Anime Origins. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Roblox game availability, release status, and updates may change without notice. We are not responsible for game access or changes made by the developers.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ANIME ORIGINS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Anime Origins Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@animeorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@animeorigins.wiki</a>
            </p>
            <p>
