...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.animeorigins.wiki'

// 内容类型优先级配置（对齐 animeorigins 实际 7 分类：codes/guide/units/teams/traits/modes/release）
